...
funciones basicas de calculo, puede mejorarse, acepto recomendaciones...saludos
...
la proxima actualizacion sera con funciones avanzadas de operaciones (seno ,coseno,tang, etc)
